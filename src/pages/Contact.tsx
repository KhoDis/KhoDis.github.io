  ...
  return (
    <>
      <p className="text-lg mb-6 text-center text-gray-700">
        ...
        <a
          href="mailto:khodzhayarov.a@gmail.com"
      ...
      <p className="text-lg mb-6 text-center text-gray-700">
        Телефон: <a href="tel:+7(932)054-12-08">+7(932)054-12-08</a>
      </p>
...
const ContactSection = Section(Contact, "Связаться", true);
