      ...
      <div className="hero">
        <div className="hero-content flex-col lg:flex-row items-start gap-8">
          ...
          <div className="space-y-4 lg:w-1/2">
            ...
            <p>
              Заканчиваю обучение в этом году в университете и нахожу свой
              энтузиазм во <strong>фронтенде</strong>. Люблю всё, что связано с
              визуалом и восприятием.
            </p>
            <p>Есть опыт создания успешных внедрённых проектов.</p>
